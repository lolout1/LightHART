...
class Encoder(nn.Module):
    ...
    def __init__(self, embed_dim, mlp_dim, num_heads, attn_drop_rate, drop_rate):
        ...
        self.attention = nn.MultiheadAttention(
            ...
            batch_first=True  # Ensures input shape is (batch, seq, embed_dim)
        )
...
class PCNNTransformer(nn.Module):
    ...
    def __init__(self, length=128, channels=3, num_layers=4, embed_dim=64, 
        ...
        Args:
            ...
            channels (int): Number of input channels (e.g., accelerometer axes).
        ...
        # Initial projection from input channels to embed_dim
        self.input_projection = nn.Linear(channels, embed_dim)
    ...
    def forward(self, x):
        ...
        if isinstance(x, dict):
            ...
            x = (phone + watch) / 2  # Averaging the two modalities
            # x now has shape: (batch, seq_len, 3)
